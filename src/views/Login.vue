  ...
  <div class="main-container flex-box">
    <div class="form-box">
      <el-row style="height: 100%" justify="space-between">
        <el-col :sm="12" :xs="0">
          <el-image style="width: 100%;height: 100%;border-radius: 5px 0 0 5px;" src="https://file.peteralbus.com/assets/blog/imgs/photo/DJI_0422.JPG" fit="cover"/>
        </el-col>
        <el-col :sm="12" :xs="24" class="flex-box" style="padding: 20px">
          ...
          >
            ...
            <div>
              <el-button type="primary" @click="submitForm(ruleFormRef)" color="#63a35c">登录</el-button>&emsp;
              <router-link to="/register"><el-button plain color="#63a35c">注册</el-button></router-link>
            </div>
          </el-form>
        </el-col>
      </el-row>
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate((valid, fields) => {
    if (valid) {
      ...
      axios.post(url,qs.stringify(loginForm))
          .then(res=>{
            if(res.data)
            {
